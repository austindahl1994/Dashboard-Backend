import { cachedBounties, simpleSources, simpleItems, simpleTypes } from '../cachedData.js'
    ...
    if (bounty.Type === "CLUE") {
      switch (bounty.Other) {
        ...
        case "valueGreater":
          ...
          break;
        case "sumLess":
          let sum = data.extra.items.reduce((item, acc) => {
        ...
        case "sumGreater": 
          ...
          break;
        default: throw new Error(`Invalid clue type in cachedBounties ${bounty.Other}`)
          break;
      }
    }
  })
